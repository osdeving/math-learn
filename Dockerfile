# Dockerfile para Math Learn Platform
...
# Copiar automaticamente arquivos de saída com base na detection
...
# server.js é criado pelo output standalone do next build
CMD ["node", "server.js"]
