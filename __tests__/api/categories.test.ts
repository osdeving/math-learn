import { GET as getById } from "@/app/api/categories/[id]/route";
...
describe("/api/categories", () => {
    ...
    describe("GET /api/categories", () => {
        ...
        it("should filter by published status", async () => {
            ...
            const request = new Request(
                "http://localhost:3000/api/categories?published=true"
            );
    ...
    describe("POST /api/categories", () => {
        it("should create new category", async () => {
            ...
            mockCategory.prototype.save = jest
                .fn()
...
describe("/api/categories/[id]", () => {
    ...
    describe("GET /api/categories/[id]", () => {
        it("should return category by id", async () => {
            ...
            const response = await getById(request as any, {
                params: { id: "123" },
            });
            const data = await response.json();
